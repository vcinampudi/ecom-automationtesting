...
5. Continue with guest checkout 
6. Click on Checkout welcome link on progress bar and check page navigation
*/
public class TC_REG_MUK_105 extends TestBase {
	...
	public void tc_REG_MUK_105(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_105");
		System.out.println(" Starting test - tc_REG_MUK_105");
		...
		wait(3);
		*/
		// Clicking on Checkout Welcome link
		click("checkoutWelcome_link_xpath");

		// Validation
		if (getElementsSize("guestCheckout_btn_xpath") > 0) {
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_105");
		System.out.println(" Ending test - tc_REG_MUK_105");
