...
*/
public class TC_REG_MUK_101 extends TestBase {
	...
	public void tc_REG_MUK_102(Hashtable<String, String> data) {
		...
		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_101");
		System.out.println(" Starting test - tc_REG_MUK_101");
		...
		// Validation
		if(getElementsSize("checkout_Btn_xpath")>0){
			reportPass("Screen is successfully navigated to Cart page");
		}
		
		else
			reportFailure("Screen is not navigated to Cart page");
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_101");
		System.out.println(" Ending test - tc_REG_MUK_101");
