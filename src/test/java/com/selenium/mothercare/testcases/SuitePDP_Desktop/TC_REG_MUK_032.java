...
/* Steps:
 1. Load MUK site
 2. Search product
 3. Validate if its variant product
 4. Change variant and check price
 */
public class TC_REG_MUK_032 extends TestBase {
	...
	public void tc_REG_MUK_032(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_032");
		System.out.println(" Starting test - tc_REG_MUK_032");
		...
		if (getElementsSize("productNotFound_text_xpath") > 0) {
			...
			//List<WebElement> colorVariants = driver.findElements(By.xpath("//ul[@class='b-swatches_wrapper swatch-list swatch-toggle']/li"));
			List<WebElement> colorVariants = driver.findElements(By.xpath("//ul[@class='b-swatches_wrapper swatch-list ']/li"));
			...
			if (colorVariants.size() > 0) {
					...
					if (!driver
						...
						driver.findElement(
								By.xpath("//ul[@class='b-swatches_wrapper swatch-list ']/li["
										+ (i + 1) + "]/a")).click();
						wait(2);
						// printing the color of the variant
						selectedColor = driver
								.findElement(
										By.xpath("//ul[@class='b-swatches_wrapper swatch-list ']/li["
												+ (i + 1) + "]/a"))
								.getAttribute("title");
						...
						// Updating the Old Price
						oldPrice = driver
								.findElement(
										By.xpath("//meta[@itemprop='priceCurrency']/../span/../meta[1]"))
								.getAttribute("content");
						System.out
								.println("Price of the current selected variant = "
										+ oldPrice);
						if (!driver
								.findElement(
										By.xpath("//ul[@class='b-swatches_wrapper swatch-list ']/li["
							...
							wait(2);
							System.out
									.println("Price of the next variant "
											+ driver.findElement(
													By.xpath("//meta[@itemprop='priceCurrency']/../span/../meta[1]"))
													.getAttribute("content"));
							if (driver
									.findElement(
											By.xpath("//meta[@itemprop='priceCurrency']/../span/../meta[1]"))
									.getAttribute("content").equals(oldPrice)) {
								oldPrice = driver
										.findElement(
												By.xpath("//meta[@itemprop='priceCurrency']/../span/../meta[1]"))
										.getAttribute("content");
								...
								reportPass("Price Has been updated based on current variant "
										+ "New Price= "
										+ driver.findElement(
												By.xpath("//meta[@itemprop='priceCurrency']/../span/../meta[1]"))
												.getAttribute("content")
				...
				if (Flag == false) {
					reportFailure("All the product variants have same price. kindly select the product , having variant's with different prices");
					System.out
							.println("All the product variants have same price. kindly select the product , having variant's with different prices");
				}
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_032");
		System.out.println(" Ending test - tc_REG_MUK_032");
