...
/* Steps:
 ...
 3. Verify rental info on basket page
 */
public class TC_REG_MUK_045 extends TestBase {
	...
	public void tc_REG_MUK_045(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_045");
		System.out.println(" Starting test - tc_REG_MUK_045");
		...
		if (getElementsSize("productNotFound_text_xpath") > 0) {
			...
			if (getElementsSize("pdp_ProductPlaceholder_RentalDate_xpath") > 0) {
				...
				if (getElementsSize("basket_personalisedInfo_text_xpath") > 0) {
					reportPass("Rental product info has been added successfully");
				} else {
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_045");
		System.out.println(" Ending test - tc_REG_MUK_045");
