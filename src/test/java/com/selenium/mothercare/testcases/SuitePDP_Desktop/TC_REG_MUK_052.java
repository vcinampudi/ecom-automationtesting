...
/* Steps:
 1. Load MUK site
 2. Search product and navigate to PDP
 3. Verify roundel availability and its value on PDP
 */
public class TC_REG_MUK_052 extends TestBase {
	...
	public void tc_REG_MUK_052(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_052");
		System.out.println(" Starting test - tc_REG_MUK_052");
		...
		if (getElementsSize("productNotFound_text_xpath") > 0) {
			...
			if (getElementsSize("pdp_ProductBadge_xpath") > 0) {
				reportPass("Product Roundel is getting displayed");
			} else {
				reportFailure("Kindly select product having roundles");
			}
		}
	}
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_052");
		System.out.println(" Ending test - tc_REG_MUK_052");
