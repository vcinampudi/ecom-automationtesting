...
/* Steps:
 1. Load MUK site
 2. Search dropship product and navigate to PDP
 3. Verify dropship message on PDP 
 */
public class TC_REG_MUK_065 extends TestBase {
	...
	public void tc_REG_MUK_065(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_065");
		System.out.println(" Starting test - tc_REG_MUK_065");
		...
		if (getElementsSize("productNotFound_text_xpath") > 0) {
			...
			if (getElementsSize("pdp_DropshipMessage_text_xpath") > 0) {
				reportPass("Dropship Product message is getting displayed");
			} else {
				reportFailure("Kindly select valid dropship product");
			}
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_065");
		System.out.println(" Ending test - tc_REG_MUK_065");
