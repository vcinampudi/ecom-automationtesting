...
/* Steps:
 1. Load MUK site
 2. Search rental product
 3. Check delivery option on PDP
 */
public class TC_REG_MUK_046 extends TestBase {
	...
	public void tc_REG_MUK_046(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_046");
		System.out.println(" Starting test - tc_REG_MUK_046");
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_046");
		System.out.println(" Ending test - tc_REG_MUK_046");
