...
/* Steps:
 ...
 3. Check award logo 
 */
public class TC_REG_MUK_039 extends TestBase {
	...
	public void tc_REG_MUK_039(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_039");
		System.out.println(" Starting test - tc_REG_MUK_039");
		...
		if (getElementsSize("productNotFound_text_xpath") > 0) {
			...
			if (getElementsSize("pdp_AwardLogo_Img_xpath") > 0) {
				reportPass("Award Logo is getting displayed");
			} else {
				reportFailure("Product doesnt have award logo, please select different product with award logo");
			}
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_039");
		System.out.println(" Ending test - tc_REG_MUK_039");
