...
/* Steps:
 1. Load MUK site
 2. Navigate to PLP screen
 3. Click on list view
 4. Verify quick view
 */
public class TC_REG_MUK_023 extends TestBase {
	...
	public void tc_REG_MUK_023(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_023");
		System.out.println(" Starting test - tc_REG_MUK_023");
		...
		// Selecting the list view Option
		click("plp_ListViewOption_Img_xpath");
		wait(1);
		
		scrollDown(0, 600);
		wait(1);

		if (driver.findElements(By.xpath("//a[.='Quick View']")).size() > 0) {
			reportPass("Quick View is getting displayed on PLP page");

		} else {
			reportFailure("Quick View is not available on PLP page, please check BM config");
		}
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_023");
		System.out.println(" Ending test - tc_REG_MUK_023");
