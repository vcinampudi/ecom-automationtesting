...
/* Steps:
 1. Load MUK site
 2. Navigate to PLP screen of any category
 3. Verify quick view option
 */
public class TC_REG_MUK_022 extends TestBase {
	...
	public void tc_REG_MUK_022(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_022");
		System.out.println(" Starting test - tc_REG_MUK_022");
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_022");
		System.out.println(" Ending test - tc_REG_MUK_022");
