...
/* Steps:
 1. Load MUK site
 2. Scroll at bottom of the page
 3. Check copyright text
 */
public class TC_REG_MUK_019 extends TestBase {
	...
	public void tc_REG_MUK_019(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_019");
		System.out.println(" Starting test - tc_REG_MUK_019");
		...
		if (getElementsSize("copyRight_text_xpath") > 0) {
			reportPass("Copyright text is displaying");
		} else
			reportFailure("Copyright text is not displaying");
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_019");
		System.out.println(" Ending test - tc_REG_MUK_019");
