 ...
 * Actual Steps:
 1. Load MUK site
 2. Check main banner and its play/pause button
 */

public class TC_REG_MUK_016 extends TestBase {
	...
	public void tc_REG_MUK_016(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_016");
		System.out.println(" Starting test - tc_REG_MUK_016");
		...
		if (getElementsSize("mainBanner_xpath") > 0 &&getElementsSize("playPause_btn_xpath")>0) {
			reportPass("Promo Slot and play stop button is displaying");
		} else
			reportFailure("Promo Slot and play stop button is not displaying");
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_016");
		System.out.println(" Ending test - tc_REG_MUK_016");
