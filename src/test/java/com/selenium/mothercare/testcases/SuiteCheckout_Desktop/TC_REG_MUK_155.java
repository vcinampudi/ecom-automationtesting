 ...
 */
public class TC_REG_MUK_155 extends TestBase {
	...
	public void tc_REG_MUK_155(Hashtable<String, String> data)
			throws IOException {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_155");
		System.out.println(" Starting test - tc_REG_MUK_155");
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_155");
		System.out.println(" Ending test - tc_REG_MUK_155");
