 ...
 */
public class TC_REG_MUK_143 extends TestBase {
	...
	public void tc_REG_MUK_143(Hashtable<String, String> data) {
		...
		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_143");
		System.out.println(" Starting test - tc_REG_MUK_143");
		...
		if (redemptionSuccessTextSize > 0) {
			...
			if (placeOrderBtn.isDisplayed()
				...
				test.log(LogStatus.INFO,
						" Kindly use the gift card greater than the order value");
				System.out
						.println(" Kindly use the gift card greater than the order value");
				reportFailure("Kindly use the gift card greater than the order value");
			}
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_143");
		System.out.println(" Ending test - tc_REG_MUK_143");
