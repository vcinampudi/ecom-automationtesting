...
Payment type=Paypal
 */
public class TC_REG_MUK_142 extends TestBase {
	...
	public void tc_REG_MUK_142(Hashtable<String, String> data) {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_142");
		System.out.println(" Starting test - tc_REG_MUK_142");
		...
		wait(2);
		payWithPayPal(data.get("PayPalUsername"), data.get("PayPalPassword"));
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_142");
		System.out.println(" Ending test - tc_REG_MUK_142");
