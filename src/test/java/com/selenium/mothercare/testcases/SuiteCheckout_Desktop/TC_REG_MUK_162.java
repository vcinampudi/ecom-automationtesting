 ...
 */
public class TC_REG_MUK_162 extends TestBase {
	...
	public void tc_REG_MUK_162(Hashtable<String, String> data) {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_162");
		System.out.println(" Starting test - tc_REG_MUK_162");
		...
		// selecting Deliver to UK address delivery option
		...
		// entering postcode and click find
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_162");
		System.out.println(" Ending test - tc_REG_MUK_162");
		wait(3);
		if (driver != null)
			driver.quit();
