 ...
 */
public class TC_REG_MUK_147 extends TestBase {
	...
	public void tc_REG_MUK_147(Hashtable<String, String> data) {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_147");
		System.out.println(" Starting test - tc_REG_MUK_147");
        ...
        wait(5);
		// selecting BFPO delivery option and proceed to payment
		selectBfpoNewAdd();
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_147");
		System.out.println(" Ending test - tc_REG_MUK_147");
