...
/* Steps:
 ...
 4. Verify standard delivery charges
 */
public class TC_REG_MUK_248 extends TestBase {
	String testCaseName = this.getClass().getSimpleName();
	SoftAssert softAssert;
	Xls_Reader xls;

	@Test(dataProvider = "getData")
	public void tc_REG_MUK_248(Hashtable<String, String> data) {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_248");
		System.out.println(" Starting test - tc_REG_MUK_248");
		...
		if (getText("paypalPopUp_StandardDelCharges_text_xpath").substring(1).equals(
				prop.getProperty("Standard"))) {
			reportPass("Standard Delivery charges has been displayed correctly for Paypal Express as : "
					+ getText("paypalPopUp_StandardDelCharges_text_xpath").substring(1));
		} else
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_248");
		System.out.println(" Ending test - tc_REG_MUK_248");
