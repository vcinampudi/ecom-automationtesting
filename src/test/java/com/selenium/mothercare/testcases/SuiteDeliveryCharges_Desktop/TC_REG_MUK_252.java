...
4. Verify channel island furniture delivery charges
*/
public class TC_REG_MUK_252 extends TestBase {
	String testCaseName = this.getClass().getSimpleName();
	SoftAssert softAssert;
	Xls_Reader xls;

	@Test(dataProvider = "getData")
	public void tc_REG_MUK_252(Hashtable<String, String> data) {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_252");
		System.out.println(" Starting test - tc_REG_MUK_252");
	...
	//	doLogin(data.get("Username"), data.get("Password"));
		...
		if (getText("paypalPopUp_ChanIslandFurnitureDelCharges_text_xpath")
				.contains(Constants.CHANNELISLAND_CHARGES_MESSAGE)) {
			reportPass("Channel Island Furniture Delivery charges text has been displayed correctly for Paypal Express as : ");
		} else
			reportFailure("Invalid Charges text is getting displayed on Paypal Express");
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_252");
		System.out.println(" Ending test - tc_REG_MUK_252");
