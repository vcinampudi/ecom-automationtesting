...
*/
public class TC_REG_MUK_251 extends TestBase {
	String testCaseName = this.getClass().getSimpleName();
	SoftAssert softAssert;
	Xls_Reader xls;

	@Test(dataProvider = "getData")
	public void tc_REG_MUK_251(Hashtable<String, String> data) {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_251");
		System.out.println(" Starting test - tc_REG_MUK_251");
		...
		if (getText("paypalPopUp_FurnitureDelCharges_text_xpath").substring(1)
				.equals(prop.getProperty("Furniture"))) {
			reportPass("UK Furniture Delivery charges has been displayed correctly for Paypal Express as : "
					+ getText("paypalPopUp_FurnitureDelCharges_text_xpath")
							.substring(1));
		} else
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_251");
		System.out.println(" Ending test - tc_REG_MUK_251");
