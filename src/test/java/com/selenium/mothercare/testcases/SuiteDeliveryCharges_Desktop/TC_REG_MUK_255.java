...
4. Verify furniture delivery charges
*/
public class TC_REG_MUK_255 extends TestBase {
	String testCaseName = this.getClass().getSimpleName();
	SoftAssert softAssert;
	Xls_Reader xls;

	@Test(dataProvider = "getData")
	public void tc_REG_MUK_255(Hashtable<String, String> data) {

		test.log(LogStatus.INFO, " Starting test - tc_REG_MUK_255");
		System.out.println(" Starting test - tc_REG_MUK_255");
		...
		if (getText("paypalPopUp_InternationalDelCharges_text_xpath")
				.equals(Constants.INTERNATIONAL_CHARGES_MESSAGE)) {
			reportPass("International Delivery charges text has been displayed correctly for Paypal Express as : ");
		} else
	...
	public void tearDown() {
		...
		test.log(LogStatus.INFO, " Ending test - tc_REG_MUK_255");
		System.out.println(" Ending test - tc_REG_MUK_255");
